        ...
        bindEvent: function(type) {
            ...
            function setDateGearTooth() {
                ...
                if (date_dd && date_dd.getAttribute("val")) {
                    ...
                    var _ddVal = parseInt(date_dd.getAttribute("val"));
                    if(_ddVal<0){
                        date_dd.setAttribute("val", 0);
                        setTimeout(function () {
                            date_dd.style["-webkit-transform"] = 'translate3d(0,'+ 6 + 'em,0)';
                            date_dd.setAttribute('top', 6 + 'em');
                        },30)
                    }
                } else {
                    return;
